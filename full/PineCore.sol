...
contract LimitCore is Order {
    ...
    function depositEth(
        ...
        require(msg.value > 0, "LimitCore#depositEth: VALUE_IS_0");
        ...
        require(inputToken == ETH_ADDRESS, "LimitCore#depositEth: WRONG_INPUT_TOKEN");
    ...
    function cancelOrder(
        ...
        require(msg.sender == _owner, "LimitCore#cancelOrder: INVALID_OWNER");
        bytes32 key = keyOf(
            _module,
            _inputToken,
            _owner,
        ...
        if (address(_inputToken) == ETH_ADDRESS) {
            ...
            require(success, "LimitCore#cancelOrder: ETHER_TRANSFER_FAILED");
        } else {
    ...
    function executeOrder(
        ...
        require(amount > 0, "LimitCore#executeOrder: INVALID_ORDER");
    ...
    function _pullOrder(
        ...
        if (address(_inputToken) == ETH_ADDRESS) {
            ...
            require(success, "LimitCore#_pullOrder: PULL_ETHER_FAILED");
        } else {
